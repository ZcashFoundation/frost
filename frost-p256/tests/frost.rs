...
fn check_generate_random_values() {
    ...
    frost_core::tests::repairable::check_generate_random_values::<P256Sha256, _>(rng);
}
...
fn check_compute_sum_of_random_values() {
    frost_core::tests::repairable::check_compute_sum_of_random_values::<P256Sha256>(&REPAIR_SHARE);
}

#[test]
fn check_recover_share() {
    let rng = thread_rng();
    frost_core::tests::repairable::check_recover_share::<P256Sha256, _>(rng, &REPAIR_SHARE);
}
