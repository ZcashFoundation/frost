...
pub type Delta = frost::keys::repairable::Delta<P256Sha256>;

/// A sigma value which is the output of part 2 of RTS.
pub type Sigma = frost::keys::repairable::Sigma<P256Sha256>;
...
pub fn repair_share_part2(deltas: &[Delta]) -> Sigma {
    frost::keys::repairable::repair_share_part2::<P256Sha256>(deltas)
}
...
mod tests {
    ...
    fn check_repair_share_part1() {
        ...
        frost_core::tests::repairable::check_repair_share_part1::<P256Sha256, _>(rng);
    }

    #[test]
    fn check_repair_share_part2() {
        frost_core::tests::repairable::check_repair_share_part2::<P256Sha256>(&REPAIR_SHARE);
    }

    #[test]
    fn check_repair_share_part3() {
        let rng = rand::rngs::OsRng;
        frost_core::tests::repairable::check_repair_share_part3::<P256Sha256, _>(
            rng,
            &REPAIR_SHARE,
        );
    }
