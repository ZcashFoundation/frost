...
pub type Delta = frost::keys::repairable::Delta<Secp256K1Sha256TR>;

/// A sigma value which is the output of part 2 of RTS.
pub type Sigma = frost::keys::repairable::Sigma<Secp256K1Sha256TR>;
...
pub fn repair_share_part2(deltas: &[Delta]) -> Sigma {
    frost::keys::repairable::repair_share_part2::<Secp256K1Sha256TR>(deltas)
}
...
mod tests {
    ...
    fn check_repair_share_part2() {
        frost_core::tests::repairable::check_repair_share_part2::<Secp256K1Sha256TR>(&REPAIR_SHARE);
    }
