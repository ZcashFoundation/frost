**Disclaimer: This is an unaudited prototype and should not be used in production code**

An implementation of Schnorr signatures on the ecGFp5 curve for both single and threshold numbers
of signers (FROST).
